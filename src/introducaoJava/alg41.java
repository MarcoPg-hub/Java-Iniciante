...
public class alg41 {
	...
	public static void main(String[] args) {
		// Entrar com quatro números inteiros e imprimir a média ponderada, sabendo que os pesos são respectivamente 1, 2, 3, e 4.
		// media ponderada é a soma dos produtos das notas pelos pesos respectivos e depois divide essa soma pela somatoria dos pesos
